...
VITE_GLOB_API_URL=https://www.haier.com
# 文件上传地址 可以由nginx做转发或者直接写实际地址
VITE_GLOB_UPLOAD_URL=https://www.haier.com/upload
# 接口地址前缀，有些系统所有接口地址都有前缀，可以在这里统一加，方便切换
VITE_GLOB_API_URL_PREFIX=
# 是否删除Console.log
...
window.__PRODUCTION__VUE_ADMIN__CONF__ = {
  VITE_GLOB_APP_TITLE: "corgi admin",
  VITE_GLOB_APP_SHORT_NAME: "corgi admin",
